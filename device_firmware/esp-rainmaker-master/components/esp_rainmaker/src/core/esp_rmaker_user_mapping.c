...
// --- Compatibility patch for ESP-IDF >= 5.0 ---
...
#define network_prov_mgr_endpoint_create   wifi_prov_mgr_endpoint_create
#define network_prov_mgr_endpoint_register wifi_prov_mgr_endpoint_register

/*
 * Compatibility layer:
 * Map old network_provisioning symbols to wifi_provisioning equivalents
 * so this file builds/works on both older IDF (network_provisioning)
 * and newer IDF (wifi_provisioning).
 */
#if !defined(NETWORK_PROV_EVENT) && defined(WIFI_PROV_EVENT)
#define NETWORK_PROV_EVENT WIFI_PROV_EVENT
#define NETWORK_PROV_INIT  WIFI_PROV_INIT
#define NETWORK_PROV_START WIFI_PROV_START
#endif

#if !defined(network_prov_mgr_endpoint_create) && defined(wifi_prov_mgr_endpoint_create)
#define network_prov_mgr_endpoint_create     wifi_prov_mgr_endpoint_create
#define network_prov_mgr_endpoint_register   wifi_prov_mgr_endpoint_register
#endif
